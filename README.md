...
5. Настройка отслеживания изменений инфраструктуры
 ...
 - для отслеживания изменений инфраструктуры используем github actions
 
 в корневой папке проекта создаем директорию .gitgub/workflows, пишем код выполнения workflow ci/cd и сохраняем в указанной дректории в виде файла с расширением yaml:
